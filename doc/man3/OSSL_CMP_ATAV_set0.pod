...
I<atav> unless it is NULL.

OSSL_CMP_ATAV_get0_value() returns a direct pointer to the infoValue in
the I<atav> as generic B<ASN1_TYPE> pointerr unless I<atav> is NULL.
...
The B<OSSL_CMP_ATAV> type and related functions were added in OpenSSL 3.2.
