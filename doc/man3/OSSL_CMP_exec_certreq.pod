...
As far as the I<newWithOld> and I<oldWithNew> output parameters are not NULL,
...
B<WARNING:>
The I<newWithNew> certificate is meant to be certificate that will be trusted.
